...
BEGIN
  ...
  FOR _anticipable_payable IN (
    SELECT * FROM anticipable_payables_filtered('{}'::int[], 0, 100, anticipable_company_id, company_max_antecipable_rate, anticipable_recipient_id, recipient_max_antecipable_rate, new_payment_date, max_created_at, anticipation_fee_rate, order_by)
  ) LOOP
