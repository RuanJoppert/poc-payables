  ...
  FOR _payable IN (
    ...
    LEFT JOIN "Payables" AS same_transaction_payable
      ...
      ( same_transaction_payable.status = 'suspended' OR
        ...
        same_transaction_payable.type = 'refund'      OR
        ( same_transaction_payable.recipient_id = payable.recipient_id AND
          same_transaction_payable.status = 'waiting_funds'            AND
          same_transaction_payable.type = 'block'
        )
      )
      WHERE
