CREATE OR REPLACE FUNCTION anticipable_from_payable(
  payable                    anticipatable_payable,
  amount_to_anticipate       BIGINT,
  gross_amount_to_anticipate BIGINT,
...
BEGIN
  ...
  _anticipable_payable.fraud_coverage_fee  = COALESCE(payable.fraud_coverage_fee, 0);
  ...
  _anticipable_payable.net_amount        = payable.amount - payable.fee - COALESCE(payable.fraud_coverage_fee, 0) - payable.anticipation_fee;
  _anticipable_payable.anticipation_fee  = payable.anticipation_fee;
  _anticipable_payable.anticipation_days = ((payable.payment_date AT TIME ZONE 'BRT')::DATE - (new_payment_date AT TIME ZONE 'BRT')::DATE);
