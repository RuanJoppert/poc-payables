...
BEGIN
  SELECT
    ...
    funding_estimated_date, transaction_id, created_at, updated_at, metadata
  INTO transfer
  ...
  movement_object.updated_at             = transfer.updated_at;
  movement_object.metadata               = transfer.metadata;
