...
BEGIN
  ...
  INTO _max_amount
  FROM
    anticipation_company_performance(anticipable_company_id, new_payment_date)     AS company_performance,
    anticipation_recipient_performance(anticipable_recipient_id, new_payment_date) AS recipient_performance;
